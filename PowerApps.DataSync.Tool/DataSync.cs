...
namespace PowerApps.DataSync.Tool
{
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Data Sync"),
        ExportMetadata("Description", "Highlight differences in tables across environment and sync the changes."),
        ExportMetadata(
            "SmallImageBase64",
    ...
    public class DataSync : PluginBase
    {
        /// <summary>
